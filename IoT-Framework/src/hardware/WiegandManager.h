// ============================================================================
// WiegandManager.h - ULTIMATE MICRO-OS V4.2.2 (EVENT-DRIVEN)
// ============================================================================
// Описание: Управление Wiegand-считывателем карт.
// Все события чтения карт публикуются в шину событий.
//
...
// - ИСПРАВЛЕНА ошибка в publishCardEvent
...
// ============================================================================
/**
 * @brief Структура события чтения карты
 */
...
/**
 * @brief Структура данных Wiegand
 */
struct WiegandData {
...
// ============================================================================
/**
 * @brief Менеджер Wiegand-считывателя
 *
 * Синглтон. Обеспечивает:
 * - Чтение карт через прерывания (D0/D1)
 * - Поддержка 26-bit, 34-bit, 37-bit форматов
 * - Проверка четности
 * - Фильтрация дребезга

...
public:
    ...
    const char* getVersion() const override { return "0.6.6"; }         // 0.6.6: broker.pass → NVS (SECRET), hostname в карточках бэкапов; 0.6.5: OTA-раздача кусками + TWDT-feed; 0.6.4: bk само-проверка в цикле; 0.6.3: правка bk.self; 0.6.2: bk.self + оверлей; 0.6.1: OTA-зеркало

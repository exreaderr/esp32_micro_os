...
// ============================================================================
// ============================================================================
// ИНФО-КАРТОЧКА ФЛОТА (5.9.0/0.5.16): профильная строка замка.
// «Циклов замка» — существующий открытый счётчик (был в подвале welcome).
// ============================================================================
uint8_t SmartLockUi::infoCardExtras(char labels[][24], char values[][32],
                                    uint8_t maxLines) {
    if (maxLines == 0) return 0;
    snprintf(labels[0], 24, "%s", "Циклов замка");
    snprintf(values[0], 32, "%lu",

...
# профиль weather_gate). Норма на 15.09.2026 (профиль 0.7.4, WgWxCode):
# 43872 PASS / 0 FAIL. Меньше — стоп.
# Было на 24.08.2026: 43751 PASS / 0 FAIL (ядро 5.8.2, приёмка мерджа).
